<?php
$public_key = sanitize_text_field( $_POST['mucaptcha_public_key'] );
update_option( 'mucaptcha_public_key', $public_key );

$secret_key = sanitize_text_field( $_POST['mucaptcha_secret_key'] );
...
$display_text = sanitize_text_field( $_POST['mucaptcha_display_text'] );
...
$line_color = sanitize_text_field( $_POST['mucaptcha_line_color'] );
update_option( 'mucaptcha_line_color', $line_color );

$line_width = intval( sanitize_text_field( $_POST['mucaptcha_line_width'] ) );
if ( $line_width > 0 ) {
  update_option( 'mucaptcha_line_width', $line_width );
}

$background_color = sanitize_text_field( $_POST['mucaptcha_background_color'] );
